...
for required_path in VERSION dewy/__main__.py udewy/__main__.py library/path.dewy library/math.dewy library/rational.dewy library/fixed.dewy library/bigint.dewy library/bigrational.dewy library/io.dewy library/reporting.dewy library/units.dewy library/doc.dewy library/linux/io.dewy library/linux/files.dewy library/linux/process.dewy library/linux/system.dewy; do

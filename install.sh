#!/usr/bin/env bash
# Install udewy into ~/.dewy and put that directory on PATH.
# A future dewy release asset will be installed next to udewy in the same folder.
set -euo pipefail

REPO='david-andrew/dewy-lang'
ASSET='udewy-linux-x86_64'
...
if already_on_path; then
    echo "udewy is on PATH in this shell."
else

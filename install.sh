...
for required_path in VERSION dewy/__main__.py udewy/__main__.py library/path.dewy library/math.dewy library/rational.dewy library/io.dewy library/units.dewy library/linux/io.dewy library/linux/system.dewy; do

...
The full suite passed with **1,799 passed, 10 skipped** after native type rendering and the string
result, source-escape, and boolean-load fixes. The 4,356-pair native
...
275 tests before the full checkpoint.

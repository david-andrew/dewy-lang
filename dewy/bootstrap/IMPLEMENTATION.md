...
The full suite passed with **1,764 passed, 10 skipped** after the type-query
and HIR-fact ports and their supporting hosted fixes. The 4,356-pair native
...
The subsequent value-bounds comparison passes, as do 289 end-to-end,
string-ownership, and function-value regressions after the defaulted-string
result fix. These later changes have not had another full-suite run.
The relational comparison and 24 dictionary/union end-to-end regressions
also pass after extending optional dictionary lookup to general unions.
The call-term comparison passes, as do 23 refinement regressions after fixing
the direction of concrete result-contract bounds. Its table-driven harness
retains all 361 cases while avoiding hundreds of separately emitted checks.

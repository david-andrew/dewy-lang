...
5. **B10 spreading** (object and array spread in literals; unpacking later) — small, and immediately useful for AST building in the bootstrap — then **B4 closures**, then **B7 user generics**, then **B9** (the harness, on the Dewy test framework once that exists).

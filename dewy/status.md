...
5. **B10a spreading** (done) and **B4a lambda-lifted local functions** (done), then **B7 user generics**, then **B9** (the harness, on the Dewy test framework once that exists); B4b closure records and B10b unpacking when needed.

...
@pytest.mark.parametrize('fixture', ['native_borrowing_failure_effects', 'native_callback_effects', 'native_analysis_worklists', 'native_index_borrowing', 'native_ambient_graph', 'native_effect_transfers'])

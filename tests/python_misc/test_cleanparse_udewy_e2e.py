...
LOWERED_CASES = [
    ...
    ('match_basics.dewy', 63),
    ('match_chains.dewy', 42),
    ...
    ('assertions.dewy', 42),
    ('assertions_runtime_fail.dewy', 101),
    ('report_layout.dewy', 42),
    ('report_features.dewy', 42),
    ('object_array_growth.dewy', 42),
    ...
    ('object_array_borrowed_params.dewy', 42),
    ('object_borrowed_params.dewy', 42),
    ('mixed_value_place_arguments.dewy', 42),
...
def test_top_level_codegen_preserves_startup_before_main() -> None:
    ...
    assert 'let value:int64 = 1' in emitted    # a literal-initialized scalar global carries its value
    assert 'let result:int64 = 0' in emitted   # a computed one is stored at startup

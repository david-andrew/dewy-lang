...
@pytest.mark.parametrize('name', ['lifecycle_factory_results', 'lifecycle_borrowed_parameters', 'lifecycle_return_owner', 'lifecycle_inherited_copy_runtime', 'lifecycle_move_runtime', 'lifecycle_local_transfers'])

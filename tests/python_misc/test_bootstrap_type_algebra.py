...
def dispatch_cases():
    ...
    return [
        ...
        ([binary], ['int', ty.RefinedType('int64', (ty.Proposition('self', '>=?', 0),))], {}, None),
        ([binary], [ty.RefinedType('int64', (ty.Proposition('self', '>=?', 0),)), 'int'], {}, None),
        ([named], [], {'x': ty.RefinedType('int64', (ty.Proposition('self', '>=?', 0),))}, None),

...
#    -> chain operator sequences into a single compound operator
...
"""
Parsing process:
- go expression by expression, top to bottom, outside to in. e.g.

a = () => { 1 + 2 * b }
b = 5
c = a + b

a = FunctionLiteral // don't include inner expr yet
b = Int
c = Add(a, b)
    <- determine return type of a, so it can be used in c

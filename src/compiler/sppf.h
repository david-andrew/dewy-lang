...
//     dict* edges;            //map<node_idx, sppf_edge>
...
// //replaces dict* edges: map<node_idx, children_idx | set<children_idx>
// typedef struct {
//     bool packed;            //whether or not this is a packed node
//     uint64_t body_idx;      //index of the production for these children
//     union {
//         uint64_t index;     //if non-packed node, index of the children vector
//         set* indices;       //if packed node, set of indices of the children vectors
//     } children;
// } sppf_edge;
